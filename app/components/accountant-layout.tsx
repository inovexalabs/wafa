...
import { ArrowLeft, ArrowRight, Award, CalendarClock, ChevronDown, LayoutDashboard, LogOut, Receipt, UserCircle } from "lucide-react";
import Dashboard from "./dashboard";
import NotificationBell from "./notification-bell";
import { getStaffProfile, signOut } from "../lib/auth";
import { useSidebarCollapsed } from "../lib/use-sidebar-collapsed";

type AccountantLayoutProps = { active: "overview" | "meetings" | "certificates" | "receipts" | "profile"; children: ReactNode };
