...
import { ArrowLeft, ArrowRight, Award, BadgeCheck, CalendarClock, ChevronDown, ChevronRight, ClipboardList, LayoutDashboard, LogOut, MessageCircle, Receipt, UserCircle } from "lucide-react";
import Dashboard from "./dashboard";
import NotificationBell from "./notification-bell";
import { getStaffProfile, signOut } from "../lib/auth";
import { useSidebarCollapsed } from "../lib/use-sidebar-collapsed";

type SuperadminLayoutProps = { active: "overview" | "meetings" | "certificates" | "my-certificates" | "receipts" | "audit" | "chat" | "profile"; children: ReactNode };
          ...
          <div className="mt-auto">
            ...
            <div className="flex items-center gap-[9px] mt-[22px] pt-[15px] border-t border-white/[.15] text-xs">
              ...
              <span className={labelClass(collapsed)}>
                ...
                <small className="block mt-[3px] text-[#91b7a3] text-[10px] whitespace-nowrap">Superadmin</small>
              </span>
            </div>
          </div>
        </aside>
          ...
          >
            <div className="flex items-center gap-[14px]">
              <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[13px] max-[650px]:hidden">
                <Link href="/superadmin" className={"no-underline transition-colors duration-200 " + (active === "overview" ? "text-ink font-semibold" : "text-muted hover:text-brand")}>
                  Superadmin
                </Link>
            ...
            <div className="flex items-center gap-[10px]">
              <NotificationBell role="superadmin" canAnnounce />
