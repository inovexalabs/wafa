	...
	if (session.user.role !== role)
		return (
			<main className="not-found-page">
				...
				<button
					className="submit-button not-found-button"
	...
	return (
		<main className="dashboard-page">
			<header className="dashboard-header">
				<img className="dashboard-mark" src="/logo.jpeg" alt="WAFA Group logo" />
				<div>
					<p className="eyebrow form-eyebrow">{labels[role]} dashboard</p>
					<h1>Welcome to WAFA</h1>
				</div>
				<button
			...
			<section className="dashboard-content">
				<p className="eyebrow form-eyebrow">Authorized workspace</p>
				<h2>{labels[role]} overview</h2>
				<p>{children ?? `This space is reserved for ${labels[role].toLowerCase()} users.`}</p>
			</section>
		</main>
	);
}
